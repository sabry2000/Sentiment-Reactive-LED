...
from raspPiInterface import sendSentimentAnalysisResults
import pandas as pd
...
headers_auth_only = {'authorization': key}
headers = {
   "authorization": key,
...
transcriptJSON = transcript_response.json()

transcript_id = transcriptJSON['id']
...
#filehandler = open('./cache.obj', 'w')
#pickle.dump(polling_response, filehandler)
...
#try:
sendSentimentAnalysisResults(sen_df)
